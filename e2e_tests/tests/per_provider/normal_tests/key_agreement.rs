...
const OUR_KEY_DATA_BRAINPOOL_R1: [u8; 32] = [0x81, 0xdb, 0x1e, 0xe1, 0x00, 0x15, 0x0f, 0xf2,
    0xea, 0x33, 0x8d, 0x70, 0x82, 0x71, 0xbe, 0x38, 0x30, 0x0c, 0xb5, 0x42, 0x41, 0xd7, 0x99, 0x50,
    0xf7, 0x7b, 0x06, 0x30, 0x39, 0x80, 0x4f, 0x1d];

const PEER_PUBLIC_KEY_BRAINPOOL_R1: [u8; 65] = [0x04, 0x8d, 0x2d, 0x68, 0x8c, 0x6c, 0xf9, 0x3e,
    0x11, 0x60, 0xad, 0x04, 0xcc, 0x44, 0x29, 0x11, 0x7d, 0xc2, 0xc4, 0x18, 0x25, 0xe1, 0xe9, 0xfc,
    0xa0, 0xad, 0xdd, 0x34, 0xe6, 0xf1, 0xb3, 0x9f, 0x7b, 0x99, 0x0c, 0x57, 0x52, 0x08, 0x12, 0xbe,
    0x51, 0x26, 0x41, 0xe4, 0x70, 0x34, 0x83, 0x21, 0x06, 0xbc, 0x7d, 0x3e, 0x8d, 0xd0, 0xe4, 0xc7,
    0xf1, 0x13, 0x6d, 0x70, 0x06, 0x54, 0x7c, 0xec, 0x6a];

const EXPECTED_OUTPUT_BRAINPOOL_R1: [u8; 32] = [0x89, 0xaf, 0xc3, 0x9d, 0x41, 0xd3, 0xb3, 0x27, 0x81,
    0x4b, 0x80, 0x94, 0x0b, 0x04, 0x25, 0x90, 0xf9, 0x65, 0x56, 0xec, 0x91, 0xe6, 0xae, 0x79, 0x39,
    0xbc, 0xe3, 0x1f, 0x3a, 0x18, 0xbf, 0x2b];
...
fn simple_raw_key_agreement() {
    ...
    let _shared_secret = client
        .raw_key_agreement(RawKeyAgreement::Ecdh, key_name.clone(), &PEER_PUBLIC_KEY_SECPR1)
        .unwrap();
}
...
fn raw_key_agreement_brainpoolpr1() {
    ...
    client
        ...
        .unwrap();
    let shared_secret = client
        .raw_key_agreement(RawKeyAgreement::Ecdh, key_name.clone(), &PEER_PUBLIC_KEY_BRAINPOOL_R1)
        .unwrap();
